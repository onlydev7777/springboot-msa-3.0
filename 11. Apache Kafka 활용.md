...
![img/section11/Kafka Client.png](img/section11/Kafka Client.png)
...
![img/section11/Kafka Connect.png](img/section11/Kafka Connect.png)
...
![img/section11/Confluent Kafka JDBC Connector Self-Hosted.png](img/section11/Confluent Kafka JDBC Connector Self-Hosted.png)
...
![img/section11/Kafka Source Connect-POST.png](img/section11/Kafka Source Connect-POST.png)
...
![img/section11/Kafka Source Connect-GET.png](img/section11/Kafka Source Connect-GET.png)
...
![img/section11/Kafka Consumer 수신 확인.png](img/section11/Kafka Consumer 수신 확인.png)
...
![img/section11/Kafka Sink Connect 테스트(Kafka Producer).png](img/section11/Kafka Sink Connect 테스트(Kafka Producer).png)
